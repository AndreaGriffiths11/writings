module.exports = {
  ...
  title: 'Andrea Liliana Griffiths',
  // the description of the website (eg. what shows on Google)
  description: "Andrea Liliana Griffiths's blog",
  ...
  siteUrl: '[![Netlify Status](https://api.netlify.com/api/v1/badges/5dbcb322-d135-43dd-ae2e-f8984c8676e6/deploy-status)](https://app.netlify.com/sites/1111ag1111/deploys)',
  social: {
    // leave the social media you do not want to appear as empty strings
    twitter: 'ALAColombia',
    medium: '@andreagriffiths11',
    facebook: '',
    github: '',
    linkedin: '',
    instagram: '',
